...
from flashbax.buffers.train_val_trajectory_buffer import (
    Experience,
...
def create_item_buffer(
    ...
    buffer = make_train_val_trajectory_buffer(
    ...
    return buffer.replace(add=add_fn, sample=sample_fn, sample_train=sample_train_fn, sample_val=sample_val_fn)  # type: ignore


def make_train_val_item_buffer(
    max_length: int,
    min_length: int,
    sample_batch_size: int,
